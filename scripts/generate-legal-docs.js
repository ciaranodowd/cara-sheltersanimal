  ...
  return new Document({
    ...
    sections: [{
      children: [
        ...
        p(`Cara Shelters ("Cara", "we", "us", "our") provides a software-as-a-service (SaaS) platform for animal rescue and rehoming organisations ("Shelters", "you", "your"). The platform includes:`),
        ...
        p(`Pricing is subject to change. We will give you at least 60 days' notice of any price increase.`),

        h3(`2.2  Payment`),
        p(`Subscriptions are billed monthly via Stripe. By providing payment details, you authorise Cara to charge the applicable subscription fee on a recurring monthly basis. All prices are exclusive of VAT where applicable.`),

        h3(`2.3  Cancellation`),
        p(`You may cancel your subscription at any time from your account settings. Cancellation takes effect at the end of the current billing period. No refunds are issued for the current billing period on cancellation.`),
        ...
        p(`The Cara-Shelter Data Processing Agreement ("DPA") governs the processing of personal data Cara carries out on your behalf. By accepting these Terms, you also accept the DPA.`),
        ...
        p(`Nothing in these Terms limits liability for death or personal injury caused by negligence, fraud, or any other liability that cannot be excluded under Irish law.`),
        ...
        bullet(`After 30 days, all Your Data will be permanently deleted from Cara's systems, except for financial records required to be retained by law.`),
        p(`Cara may terminate your account immediately and without notice for material breach of these Terms, including but not limited to non-payment of subscription fees or violation of the Acceptable Use provisions.`),
        ...
        h2(`9. Governing Law`),
        p(`These Terms are governed by the laws of the Republic of Ireland. Any disputes arising from these Terms shall be subject to the exclusive jurisdiction of the courts of the Republic of Ireland.`),
