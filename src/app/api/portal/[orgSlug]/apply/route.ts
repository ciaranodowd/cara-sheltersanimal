...
export async function POST(
  ...
  const {
    ...
    householdSize, howLongConsidering, householdAgreed, hasAllergies,
    someoneHomeDuringDay, hoursAlonePerDay, dogSleepLocation, dogDayLocation,
    primaryCaregiver, exercisePlans, trainingPlans, vetName, vetAddress,
    petInsurance, dreamEnergyLevel, dreamTraits,
  } = body
  ...
  const application = await (prisma.adoptionApplication.create as any)({
    data: {
      ...
      householdSize: typeof householdSize === "string" ? householdSize.trim() || null : null,
      howLongConsidering: howLongConsidering?.trim() || null,
      householdAgreed: householdAgreed?.trim() || null,
      hasAllergies: hasAllergies?.trim() || null,
      someoneHomeDuringDay: someoneHomeDuringDay?.trim() || null,
      hoursAlonePerDay: hoursAlonePerDay?.trim() || null,
      dogSleepLocation: dogSleepLocation?.trim() || null,
      dogDayLocation: dogDayLocation?.trim() || null,
      primaryCaregiver: typeof primaryCaregiver === "string" ? primaryCaregiver.trim() || null : null,
      exercisePlans: typeof exercisePlans === "string" ? exercisePlans.trim() || null : null,
      trainingPlans: typeof trainingPlans === "string" ? trainingPlans.trim() || null : null,
      vetName: typeof vetName === "string" ? vetName.trim() || null : null,
      vetAddress: typeof vetAddress === "string" ? vetAddress.trim() || null : null,
      petInsurance: petInsurance?.trim() || null,
      dreamEnergyLevel: dreamEnergyLevel?.trim() || null,
      dreamTraits: typeof dreamTraits === "string" ? dreamTraits.trim() || null : null,
