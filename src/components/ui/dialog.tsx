  ...
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content ref={ref} className={cn(
        ...
        // mobile: bottom sheet (slides up from bottom, leaves ≥60px bg visible)
        "bottom-0 left-0 right-0 rounded-t-2xl max-h-[90vh] overflow-y-auto p-6",
        "max-sm:data-[state=closed]:slide-out-to-bottom max-sm:data-[state=open]:slide-in-from-bottom",
        // sm+: centered modal
        "sm:bottom-auto sm:left-[50%] sm:top-[50%] sm:max-w-lg",
        "sm:translate-x-[-50%] sm:translate-y-[-50%]",
        "sm:rounded-xl sm:max-h-none sm:overflow-visible",
